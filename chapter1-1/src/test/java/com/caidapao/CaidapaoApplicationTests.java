...
import com.caidapao.web.TestRestFulController;
...
public class CaidapaoApplicationTests {
    ...
    public void getHello() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get("/rest/test?name=caidapao&sex=man").accept(MediaType.APPLICATION_JSON))
